    ...
    return (
        <div className="px-6 py-10 mt-24 rounded bg-black/80 mtLmt-0 md:max-w-sm md:px-14">
            <form>
                ...
                <button type="submit"  className='w-full bg-[#e50914] rounded p-2 text-white duration-300 hover:contrast-110'>Sign Up</button>
                </div>
            ...
            <div className='mt-4 text-sm text-gray-200'>
                Already Have an account? <Link href='/login'  className='text-white duration-200 hover:underline'>Login</Link>
            </div>
